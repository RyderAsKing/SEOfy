        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <span
                                class="ml-2 bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded">@if(auth()->user()->is_admin)admin
                ...
                <form method="get" action="{{ route('impersonate.leave') }}">
                    @csrf
                    <x-dropdown-link :href="route('impersonate.leave')" onclick="event.preventDefault();
                                                this.closest('form').submit();">
