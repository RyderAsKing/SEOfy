        ...
        <div class="col-span-2 flex flex-col gap-2">
            <div class="w-full">
                <h1 class="text-xl mb-1 flex justify-between">Visitors <span class="inline-flex rounded-md shadow-sm">
                        <a href="{{ route('admin.projects.show', $project)}}?timeframe=today"
                        ...
                        <a href="{{ route('admin.projects.show', $project)}}?timeframe=week"
                        ...
                        <a href="{{ route('admin.projects.show', $project)}}?timeframe=month"
